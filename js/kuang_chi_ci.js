...
d3.select("#Content-chidao").remove()
d3.select("#Content-TOP-RIGHT2").append("div").attr("id","Content-chidao")
var Chart_cidao = echarts.init(document.getElementById('Content-chidao'),'dark');
var name_chi_zao=[];
